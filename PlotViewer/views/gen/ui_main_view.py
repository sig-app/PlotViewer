...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionLoad_Figure_list = QtGui.QAction(MainWindow)
        self.actionLoad_Figure_list.setObjectName(_fromUtf8("actionLoad_Figure_list"))
        self.actionSave_Figure_list = QtGui.QAction(MainWindow)
        self.actionSave_Figure_list.setObjectName(_fromUtf8("actionSave_Figure_list"))
        self.menuFiles.addAction(self.actionLoad_Figure_list)
        self.menuFiles.addAction(self.actionSave_Figure_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLoad_Figure_list.setText(_translate("MainWindow", "Load Figure list", None))
        self.actionSave_Figure_list.setText(_translate("MainWindow", "Save Figure list", None))
